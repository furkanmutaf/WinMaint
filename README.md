...
Windows'ta zamanla biriken temp dosyaları, DNS artıkları ve DISM şişkinlikleriyle uğraşmaktan sıkılıp yazdığım modüler bakım ve temizlik betiği.
...
Windows'un kendi disk temizleme aracı veya piyasadaki 3. parti temizleyiciler ya neyi sildiğini tam söylemiyor ya da sistemi bozacak kadar agresif çalışabiliyor.
